...
**1) Какие особенности можно наблюдать по сравнению с секвенированием ДНК или РНК?** (нужно ответить)
...
**f) Визуализация метилирования и покрытия каждого образца (нужно вставить и сделать выводы)
